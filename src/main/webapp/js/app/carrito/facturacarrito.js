...
//        }
        ...
        $scope.pdf = function (ajaxDataUsuarios) {

            var arrayPosi = [90, 110, 130, 150];
            ...
            var doc = new jsPDF();
            // titulo, logo, datos empresa
            doc.setFontSize(30);
            doc.text(80, 25, "FACTURA");
            doc.addImage(imgData, 'GIF', 140, 20, 60, 70);

            doc.setFontSize(15);
            doc.text(10, 45, "LIZ CIMIENTOS S.L.");
            doc.text(10, 55, "C/ Juan Turrol, nº27");
            doc.text(10, 65, "Valencia (41002)");
            doc.text(10, 75, "Tel. 961548877");

            // lineas
            doc.text(25, 80, 'Descripcion');
            doc.text(90, 80, 'Cantidad');
            doc.text(160, 80, 'Precio');

//            for (var i = 0; i < ajaxDataUsuarios.length; i++) {
//                doc.setFontType("normal");
//                doc.setFontSize(16);
//                doc.text(25, arrayPosi[i], `${ajaxDataUsuarios[i].obj_producto.desc}`);
//                doc.text(90, arrayPosi[i], `${ajaxDataUsuarios[i].cantidad}`);
//                cantidad = cantidad + ajaxDataUsuarios[i].cantidad;
//                doc.text(160, arrayPosi[i], `${ajaxDataUsuarios[i].obj_producto.precio}`);
//                precio = precio + (ajaxDataUsuarios[i].obj_producto.precio * ajaxDataUsuarios[i].cantidad);
//            }




            doc.text(10, 95, "TOTAL:");
